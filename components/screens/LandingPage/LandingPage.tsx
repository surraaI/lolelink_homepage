        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          ...
          <ScrollAnimation animation="fade-up" delay={400}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors hover-lift font-['Inter']">
              ...
              <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors hover-lift font-['Inter']">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">Sales & CRM</h4>
